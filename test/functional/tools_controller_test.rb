...
class ToolsControllerTest < ActionController::TestCase
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post :create, tool: { bought_on: @tool.bought_on, material: @tool.material, name: @tool.name, weight: @tool.weight }
    end
  ...
  test "should update tool" do
    put :update, id: @tool, tool: { bought_on: @tool.bought_on, material: @tool.material, name: @tool.name, weight: @tool.weight }
    assert_redirected_to tool_path(assigns(:tool))
  end
